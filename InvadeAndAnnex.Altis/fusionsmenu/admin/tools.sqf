...
if ((getPlayerUID player) in ["76561198080706858"]) then { //all admins
	if ((getPlayerUID player) in ["76561198080706858"]) then { //Admins Go Here aswell
		adminmenu =
		[
			["Fusions Menu",true],
...
[
	["Air",true],
		["MH-9 Hummingbird", [2],  "", -5, [["expression", format[_EXECscript5,"air_mh-9_hummingbird.sqf"]]], "1", "1"],
		["AH-9 Pawnee", [3],  "", -5, [["expression", format[_EXECscript5,"air_ah-9_pawnee_armed.sqf"]]], "1", "1"],
		["Exit", [13], "", -3, [["expression", ""]], "1", "1"]
];
Soldier = 
[
